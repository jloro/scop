...
/*   Updated: 2019/04/15 14:32:04 by jloro            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <glad.h>
...
void leave(GLFWwindow *window, t_vec3 *pos)
{
...
int main()
{
	...
	target = vec3_set(0.0f, 0.0f, 0.0f);
	pos = vec3_set(0.0f, 0.0f, 10.0f);
	glfwInit();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = mat4_look_at(vec3_set(0.0f, 1.0f, 0.0f), target, vec3_set(0.0f, 0.0f, 10.0f));
